    ...
    return (
        <div key={user._id} className='p-4 pt-6 flex-col justify-between w-72 shadow border border-gray-200 rounded-md'>
            ...
            <div className='flex mt-4 gap-2'>
                <button disabled={currentUser?.following.includes(user._id)} onClick={handleFollow} className='w-full py-2 rounded-md flex justify-center font-stretch-ultra-condensed gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer'>
