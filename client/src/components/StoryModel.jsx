...
const StoryModel = ({setShowModel,fetchStories}) => {
    ...
    return (
      ...
      <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur-2xl text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
          ...
          <div className='ropunded-lg h-96 items-center justify-center relative' style={{backgroundColor: background}}>
            {
              mode === 'text' && (
            ...
            }
            {
              mode === 'media' && previewUrl && (
                media?.type.startsWith('image') ? (
                  ...
                  (
                    <video src={previewUrl} controls className='object-contain max-w-full' />
                  )
              )
            }
          </div>
